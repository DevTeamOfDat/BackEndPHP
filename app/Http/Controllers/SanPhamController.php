...
class SanPhamController extends Controller
{
     ...
     *
     * @param  int $id
     * @return \Illuminate\Contracts\Foundation\Application|ResponseFactory|\Illuminate\Http\JsonResponse|\Illuminate\Http\Response
     */
...
//            ->get(HinhAnhSanPhamController::hinh_anh);
        if ($obj) {
//            if (is_string($obj[0]->image)){
//                $obj[0]->image = utf8_encode($obj[0]->image);
//            }
//            $obj[0]->image = mb_convert_encoding($obj[0]->image, 'UTF-8', 'UTF-8');
            $test = base64_decode($obj[0]->image);
//            return response($test)->header('Content-type', 'image/png');
//            return response($test, 206)->header('Content-type','image/png')
//                    ->header('header0', 'a')
//                    ->header('header1', $obj[0]->ten_san_pham)
//                    ->header("header2", 'a');
